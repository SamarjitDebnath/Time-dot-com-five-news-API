...
Parse website (TIME.COM) and create a API that gives 5 articles of the news website in the JSON format.

Submitted by: Samarjit Debnath(NIT Agartala, 17UEC039)
"""
